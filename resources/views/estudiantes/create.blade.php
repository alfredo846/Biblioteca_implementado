                        ...
                        <div class="col-12 col-lg-10">
                            ...
                            <div class="form-floating my-2">
                                <input
                                    ...
                                    id="input-text"
                                    required>
                                <label for="input-text">Nombre alumno</label>
                            ...
                            <!-- Input Select -->
                            <div class="form-floating my-2">
                                <select name="idca" {{-- <-- Nombre del Campo --}} id="role_select" class="form-select form-control" autocomplete="off" value="{{ old( 'idca' ) }}" placeholder="Carrera" required>
